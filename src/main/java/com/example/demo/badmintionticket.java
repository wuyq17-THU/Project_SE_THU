...
public class badmintonticket {
	...
	//根据用户的名字查询他的订单信息
	//TODO需要返回一个订单类
	public 订单类 badmintonticket_getfromUser(String GetUser)  {
	...
	public List<订单类> badmintonticket_getAll(int type)  {
		
		String sql = "SELECT user FROM badmintonticket";
		List<String>users = jdbcTemplate.queryForList(sql,string.class);
		
		//TODO对list中的所有对象用badmintonticket_getfromUser即可查询一个订单类的List
